...
function sso_checkauth($login, $password) {
    ...
    if (!isset($attributes[$sso_ssp_att_name][0]) || !isset($attributes['eduPersonAffiliation']) || !isset($attributes[$sso_ssp_att_login][0]) || !isset($attributes[$sso_ssp_att_email][0]) || $attributes[$sso_ssp_att_name][0] == '' || $attributes['eduPersonAffiliation'] == '' || $attributes[$sso_ssp_att_login][0] == '' || $attributes[$sso_ssp_att_email][0] == '') {
