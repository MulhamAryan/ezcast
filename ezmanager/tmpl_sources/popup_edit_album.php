        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <p class="form-control-static">
                    <?php
                    if (isset($album_meta['course_code_public']) && $album_meta['course_code_public'] != "") {
...
<?php } ?>
                $('#modal').modal('hide');
                setTimeout(function () {
                    display_bootstrap_modal_url($('#modal'), 'index.php?action=edit_album&session_id=<?php echo session_id(); ?>&album=<?php echo $album; ?>&moderation=<?php echo $moderation; ?>&intro=' + intro + '&add_title=' +
