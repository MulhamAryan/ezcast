...
<div class="modal-body">
    ...
    <center>
        ...
        <a class="btn btn-default" onClick="$('#delete_album_load').load('index.php?action=delete_asset&album=<?php echo $album; ?>&asset=<?php echo $asset_name; ?>', function (responseData) {
