...
function download_from_recorder() {
    ...
    if ((strpos($record_type, "cam" != false) && strpos($download_info_xml, "cam_protocol") == false) || (strpos($record_type, "slide" != false) && strpos($download_info_xml, "slide_protocol") == false)
    ) {
