...
<table class="table table-striped table-hover table-condensed table-responsive courses">
    ...
    <?php foreach ($courses as $course) {
        ...
        <tr>               
            ...
            <td><span title="<?php echo $course['course_name']; ?>"><a href="index.php?action=view_course_details&amp;course_code=<?php echo urlencode($course['course_code']); ?>"><?php
                        if (isset($course['course_code_public']) && $course['course_code_public'] != "") {
